...
//createmember( member:any): Observable<any> {
  const uploadData = new FormData();
    ...
    alert("Im at member service - line 26 - selectedFile: "+ member.image
    );
    ...
    uploadData.append("image", member.image);
...
editmemberStatus(id:any): Observable<any> {
  ...
  const Status: boolean = false;
      ...
      return this.http.put(`${this.myAppUrl}${this.myApiUrl}/update-memberStatus/${id}`, Status )}
