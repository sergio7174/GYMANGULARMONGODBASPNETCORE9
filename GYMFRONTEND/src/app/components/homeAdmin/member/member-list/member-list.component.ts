...
getDatamembers() {
  ...
  this.memberService.getmemberList().pipe(
    ...
    next: (response) => {
     ...
     /*alert("Estoy en listmembers-component - line 84 - this.Datamembers.Members.namemember="+ this.Datamembers[0].namemember);
     alert("Estoy en listmembers-component - line 85 - this.Datamembers.Members[0].email="+ this.Datamembers[0].email);
    ...
    //alert ("Line-117 - Finish_day: "+ this.Finish_day[index]);
    //alert (" Line 118 - this.Finish_day_mathFloor[index]: "+ this.Finish_day_mathFloor[index]);
     ...
     // return this.daysLeft_mathFloor[index];
      ...
      if (!this.items){
        this.toast.error('Something Got Wrong .....'); 
    }
