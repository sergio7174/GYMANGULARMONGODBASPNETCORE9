  ...
  getDataStaff() {
    ...
    this.staffService.getstaffList().pipe(
      ...
      next: (response) => {
       ...
       alert("Estoy en listStaffs-component - line 84 - this.DataStaff.Categories.classname="+ this.DataStaff.Categories[0].classname);
       alert("Estoy en listStaffs-component - line 85 - this.DataStaff.Staff.image="+ this.DataStaff.Categories[0].image);
...
deleteDetails (Data:any,index:any,event:any) {
  ...
  //alert("EStoy en listStaffs - line 109 - Data.id: "+Data.id);
...
editDetails(id:any){
  ...
  //alert("Estoy en listStaffs component - line 136 - to ediStaff Comp .. id: "+id);
