...
ngOnInit(): void {
  ...
  alert ("Estoy en ngOnInit - category-edit.component - line 88 - id: "+id);
...
EditPack(): void{
      ...
      //alert("Estoy en editpack - line 170 - this.OldImage: " + this.OldImage);
      ...
      /*** service to erase old image  ****************************************/
       ...
       this.packService.deleteImage(this.OldImage).pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
        next: (response) => {
          ...
          //alert ("Estoy en EditPack - line 181 - DeleteImage - messagefound: " );
          //alert ("Estoy en EditPack - line 181 - DeleteImage - messagefound: " + messagefound );
          //alert ("Estoy en EditPack - line 182 - DeleteImage - messagefound: " + messageNotfound );        
        }
      ...
      /* alert ("Estoy en EditPack - line - 170 -selectedFile:"+this.selectedFile)
       ...
       //alert ("Estoy en EditPack - line - 195 - id: "+ id)
