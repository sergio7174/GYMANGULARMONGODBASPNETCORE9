  ...
  getDataPack() {
    ...
    this.packService.getpackList().pipe(
      ...
      next: (response) => {
       ...
       //alert("Estoy en listPacks-component - line 86 - this.DataPack.Pack[0].image="+ this.DataPack.packs.image);
...
deleteDetails (Data:any,index:any,event:any) {
  ...
  //alert("EStoy en listPacks - line 111 - Data.image: "+Data.image);
  //alert("EStoy en listPacks - line 111 - Data.id: "+Data.id);
...
editDetails(id:any){
  ...
  //alert("Estoy en listPacks component - line 134 - to ediPack Comp .. id: "+id);
